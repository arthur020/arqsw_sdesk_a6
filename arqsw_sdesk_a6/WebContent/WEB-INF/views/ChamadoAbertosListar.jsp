	...
	<div id="main" class="container">
							...
							<c:forEach var="chamado" items="${chamados}">
								<tr>
									...
									<td align="center"><fmt:formatDate
											value="${chamado.dataAbertura }" pattern="dd/MM/yyyy" /></td>
									<td align="center"><fmt:formatDate
											value="${chamado.dataFechamento }" pattern="dd/MM/yyyy" /></td>
									<td>${chamado.status }</td>
									<td align="right"><fmt:formatNumber type="number"
											value="${chamado.tempoDias}" /></td>
									<td><a href="fechar_chamado/${chamado.numero}" class="btn btn-danger">Fechar</a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
		...
		<c:if test="${empty chamados}">
			<div class="alert alert-info" role="alert">N&atilde;o h&aacute;
				chamados abertos nesta fila.</div>
		</c:if>
